...
public class HydratedInventoryChangeMap : IDisposable, IDictionary<string, MothershipHydratedInventoryChange>, ICollection<KeyValuePair<string, MothershipHydratedInventoryChange>>, IEnumerable<KeyValuePair<string, MothershipHydratedInventoryChange>>, IEnumerable
{
		...
		lock (this)
		{
			if (this.swigCPtr.Handle != IntPtr.Zero)
			{
				if (this.swigCMemOwn)
				{
					...
					MothershipApiPINVOKE.delete_HydratedInventoryChangeMap(this.swigCPtr);
				}
	...
	public ICollection<MothershipHydratedInventoryChange> Values
	{
		get
		{
			...
			foreach (KeyValuePair<string, MothershipHydratedInventoryChange> keyValuePair in this)
			{
	...
	{
		return new HydratedInventoryChangeMap.HydratedInventoryChangeMapEnumerator(this);
	}
	...
	public HydratedInventoryChangeMap.HydratedInventoryChangeMapEnumerator GetEnumerator()
	{
		return new HydratedInventoryChangeMap.HydratedInventoryChangeMapEnumerator(this);
	}

	public HydratedInventoryChangeMap() : this(MothershipApiPINVOKE.new_HydratedInventoryChangeMap__SWIG_0(), true)
	{
	...
	public HydratedInventoryChangeMap(HydratedInventoryChangeMap other) : this(MothershipApiPINVOKE.new_HydratedInventoryChangeMap__SWIG_1(HydratedInventoryChangeMap.getCPtr(other)), true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private uint size()
	{
		uint result = MothershipApiPINVOKE.HydratedInventoryChangeMap_size(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public bool empty()
	{
		bool result = MothershipApiPINVOKE.HydratedInventoryChangeMap_empty(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void Clear()
	{
		MothershipApiPINVOKE.HydratedInventoryChangeMap_Clear(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipHydratedInventoryChange result = new MothershipHydratedInventoryChange(MothershipApiPINVOKE.HydratedInventoryChangeMap_getitem(this.swigCPtr, key), false);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.HydratedInventoryChangeMap_setitem(this.swigCPtr, key, MothershipHydratedInventoryChange.getCPtr(x));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.HydratedInventoryChangeMap_ContainsKey(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.HydratedInventoryChangeMap_Add(this.swigCPtr, key, MothershipHydratedInventoryChange.getCPtr(val));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.HydratedInventoryChangeMap_Remove(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		IntPtr result = MothershipApiPINVOKE.HydratedInventoryChangeMap_create_iterator_begin(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = MothershipApiPINVOKE.HydratedInventoryChangeMap_get_next_key(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.HydratedInventoryChangeMap_destroy_iterator(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public sealed class HydratedInventoryChangeMapEnumerator : IEnumerator, IEnumerator<KeyValuePair<string, MothershipHydratedInventoryChange>>, IDisposable
	{
		...
		public KeyValuePair<string, MothershipHydratedInventoryChange> Current
		{
			get
			{
				...
				return (KeyValuePair<string, MothershipHydratedInventoryChange>)this.currentObject;
			}
		}
		...
		public bool MoveNext()
		{
			...
			if (flag)
			{
				...
				this.currentObject = new KeyValuePair<string, MothershipHydratedInventoryChange>(key, this.collectionRef[key]);
				return flag;
			}
			this.currentObject = null;
			return flag;
