...
public class MothershipWebSocketMessage : IDisposable
{
		...
		lock (this)
		{
			if (this.swigCPtr.Handle != IntPtr.Zero)
			{
				if (this.swigCMemOwn)
				{
					...
					MothershipApiPINVOKE.delete_MothershipWebSocketMessage(this.swigCPtr);
				}
	...
	{
		bool result = MothershipApiPINVOKE.MothershipWebSocketMessage_ParseFromMessageString(this.swigCPtr, message);
	...
	public MothershipWebSocketMessage() : this(MothershipApiPINVOKE.new_MothershipWebSocketMessage(), true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
