...
public class SharedGroupDataRecordMap : IDisposable, IDictionary<string, SharedGroupDataRecord>, ICollection<KeyValuePair<string, SharedGroupDataRecord>>, IEnumerable<KeyValuePair<string, SharedGroupDataRecord>>, IEnumerable
{
		...
		lock (this)
		{
			if (this.swigCPtr.Handle != IntPtr.Zero)
			{
				if (this.swigCMemOwn)
				{
					...
					MothershipApiPINVOKE.delete_SharedGroupDataRecordMap(this.swigCPtr);
				}
	...
	public ICollection<SharedGroupDataRecord> Values
	{
		get
		{
			...
			foreach (KeyValuePair<string, SharedGroupDataRecord> keyValuePair in this)
			{
	...
	{
		return new SharedGroupDataRecordMap.SharedGroupDataRecordMapEnumerator(this);
	}
	...
	public SharedGroupDataRecordMap.SharedGroupDataRecordMapEnumerator GetEnumerator()
	{
		return new SharedGroupDataRecordMap.SharedGroupDataRecordMapEnumerator(this);
	}

	public SharedGroupDataRecordMap() : this(MothershipApiPINVOKE.new_SharedGroupDataRecordMap__SWIG_0(), true)
	{
	...
	public SharedGroupDataRecordMap(SharedGroupDataRecordMap other) : this(MothershipApiPINVOKE.new_SharedGroupDataRecordMap__SWIG_1(SharedGroupDataRecordMap.getCPtr(other)), true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private uint size()
	{
		uint result = MothershipApiPINVOKE.SharedGroupDataRecordMap_size(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public bool empty()
	{
		bool result = MothershipApiPINVOKE.SharedGroupDataRecordMap_empty(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void Clear()
	{
		MothershipApiPINVOKE.SharedGroupDataRecordMap_Clear(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		SharedGroupDataRecord result = new SharedGroupDataRecord(MothershipApiPINVOKE.SharedGroupDataRecordMap_getitem(this.swigCPtr, key), false);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.SharedGroupDataRecordMap_setitem(this.swigCPtr, key, SharedGroupDataRecord.getCPtr(x));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.SharedGroupDataRecordMap_ContainsKey(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.SharedGroupDataRecordMap_Add(this.swigCPtr, key, SharedGroupDataRecord.getCPtr(val));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.SharedGroupDataRecordMap_Remove(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		IntPtr result = MothershipApiPINVOKE.SharedGroupDataRecordMap_create_iterator_begin(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = MothershipApiPINVOKE.SharedGroupDataRecordMap_get_next_key(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.SharedGroupDataRecordMap_destroy_iterator(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public sealed class SharedGroupDataRecordMapEnumerator : IEnumerator, IEnumerator<KeyValuePair<string, SharedGroupDataRecord>>, IDisposable
	{
		...
		public KeyValuePair<string, SharedGroupDataRecord> Current
		{
			get
			{
				...
				return (KeyValuePair<string, SharedGroupDataRecord>)this.currentObject;
			}
		}
		...
		public bool MoveNext()
		{
			...
			if (flag)
			{
				...
				this.currentObject = new KeyValuePair<string, SharedGroupDataRecord>(key, this.collectionRef[key]);
				return flag;
			}
			this.currentObject = null;
			return flag;
