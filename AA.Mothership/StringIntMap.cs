...
public class StringIntMap : IDisposable, IDictionary<string, int>, ICollection<KeyValuePair<string, int>>, IEnumerable<KeyValuePair<string, int>>, IEnumerable
{
		...
		lock (this)
		{
			if (this.swigCPtr.Handle != IntPtr.Zero)
			{
				if (this.swigCMemOwn)
				{
					...
					MothershipApiPINVOKE.delete_StringIntMap(this.swigCPtr);
				}
	...
	{
		return new StringIntMap.StringIntMapEnumerator(this);
	}
	...
	public StringIntMap.StringIntMapEnumerator GetEnumerator()
	{
		return new StringIntMap.StringIntMapEnumerator(this);
	}

	public StringIntMap() : this(MothershipApiPINVOKE.new_StringIntMap__SWIG_0(), true)
	{
	...
	public StringIntMap(StringIntMap other) : this(MothershipApiPINVOKE.new_StringIntMap__SWIG_1(StringIntMap.getCPtr(other)), true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private uint size()
	{
		uint result = MothershipApiPINVOKE.StringIntMap_size(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public bool empty()
	{
		bool result = MothershipApiPINVOKE.StringIntMap_empty(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void Clear()
	{
		MothershipApiPINVOKE.StringIntMap_Clear(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		int result = MothershipApiPINVOKE.StringIntMap_getitem(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.StringIntMap_setitem(this.swigCPtr, key, x);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.StringIntMap_ContainsKey(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.StringIntMap_Add(this.swigCPtr, key, val);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.StringIntMap_Remove(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		IntPtr result = MothershipApiPINVOKE.StringIntMap_create_iterator_begin(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = MothershipApiPINVOKE.StringIntMap_get_next_key(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.StringIntMap_destroy_iterator(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public sealed class StringIntMapEnumerator : IEnumerator, IEnumerator<KeyValuePair<string, int>>, IDisposable
	{
		...
		public KeyValuePair<string, int> Current
		{
			get
			{
				...
				return (KeyValuePair<string, int>)this.currentObject;
			}
		}
		...
		public bool MoveNext()
		{
			...
			if (flag)
			{
				...
				this.currentObject = new KeyValuePair<string, int>(key, this.collectionRef[key]);
				return flag;
			}
			this.currentObject = null;
			return flag;
