...
public class UserInventoryMap : IDisposable, IDictionary<string, MothershipPlayerInventorySummary>, ICollection<KeyValuePair<string, MothershipPlayerInventorySummary>>, IEnumerable<KeyValuePair<string, MothershipPlayerInventorySummary>>, IEnumerable
{
		...
		lock (this)
		{
			if (this.swigCPtr.Handle != IntPtr.Zero)
			{
				if (this.swigCMemOwn)
				{
					...
					MothershipApiPINVOKE.delete_UserInventoryMap(this.swigCPtr);
				}
	...
	public ICollection<MothershipPlayerInventorySummary> Values
	{
		get
		{
			...
			foreach (KeyValuePair<string, MothershipPlayerInventorySummary> keyValuePair in this)
			{
	...
	{
		return new UserInventoryMap.UserInventoryMapEnumerator(this);
	}
	...
	public UserInventoryMap.UserInventoryMapEnumerator GetEnumerator()
	{
		return new UserInventoryMap.UserInventoryMapEnumerator(this);
	}

	public UserInventoryMap() : this(MothershipApiPINVOKE.new_UserInventoryMap__SWIG_0(), true)
	{
	...
	public UserInventoryMap(UserInventoryMap other) : this(MothershipApiPINVOKE.new_UserInventoryMap__SWIG_1(UserInventoryMap.getCPtr(other)), true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private uint size()
	{
		uint result = MothershipApiPINVOKE.UserInventoryMap_size(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public bool empty()
	{
		bool result = MothershipApiPINVOKE.UserInventoryMap_empty(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void Clear()
	{
		MothershipApiPINVOKE.UserInventoryMap_Clear(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipPlayerInventorySummary result = new MothershipPlayerInventorySummary(MothershipApiPINVOKE.UserInventoryMap_getitem(this.swigCPtr, key), false);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.UserInventoryMap_setitem(this.swigCPtr, key, MothershipPlayerInventorySummary.getCPtr(x));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.UserInventoryMap_ContainsKey(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.UserInventoryMap_Add(this.swigCPtr, key, MothershipPlayerInventorySummary.getCPtr(val));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.UserInventoryMap_Remove(this.swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		IntPtr result = MothershipApiPINVOKE.UserInventoryMap_create_iterator_begin(this.swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = MothershipApiPINVOKE.UserInventoryMap_get_next_key(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.UserInventoryMap_destroy_iterator(this.swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public sealed class UserInventoryMapEnumerator : IEnumerator, IEnumerator<KeyValuePair<string, MothershipPlayerInventorySummary>>, IDisposable
	{
		...
		public KeyValuePair<string, MothershipPlayerInventorySummary> Current
		{
			get
			{
				...
				return (KeyValuePair<string, MothershipPlayerInventorySummary>)this.currentObject;
			}
		}
		...
		public bool MoveNext()
		{
			...
			if (flag)
			{
				...
				this.currentObject = new KeyValuePair<string, MothershipPlayerInventorySummary>(key, this.collectionRef[key]);
				return flag;
			}
			this.currentObject = null;
			return flag;
