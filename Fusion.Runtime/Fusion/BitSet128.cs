...
namespace Fusion
{
	...
	{
		public BitSet128.Iterator GetIterator()
		{
			return new BitSet128.Iterator(this);
		}
		...
		{
			return Maths.CountSetBits(this.Bits.FixedElementField) + Maths.CountSetBits(*(ref this.Bits.FixedElementField + 8));
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public unsafe bool Any()
		{
			return this.Bits.FixedElementField != 0UL || *(ref this.Bits.FixedElementField + 8) > 0UL;
		}
		...
		public unsafe override int GetHashCode()
		{
			...
			{
				ulong* ptr2 = ptr;
				return HashCodeUtilities.GetArrayHashCode<ulong>(ptr2, 2, 43);
			}
		}
		...
		{
			return this.Bits.FixedElementField == other.Bits.FixedElementField && *(ref this.Bits.FixedElementField + 8) == *(ref other.Bits.FixedElementField + 8);
		}

		public unsafe BitSet128.Enumerator GetEnumerator()
		{
			fixed (ulong* ptr = &this.Bits.FixedElementField)
			{
				ulong* bits = ptr;
				return new BitSet128.Enumerator(bits);
			}
		}
		...
		[FieldOffset(0)]
		public BitSet128.<Bits>e__FixedBuffer Bits;
