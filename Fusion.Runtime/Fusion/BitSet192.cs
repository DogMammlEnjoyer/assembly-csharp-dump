...
namespace Fusion
{
	...
	{
		public BitSet192.Iterator GetIterator()
		{
			return new BitSet192.Iterator(this);
		}
		...
		public unsafe void And(BitSet192 other)
		{
		...
		public unsafe void Or(BitSet192 other)
		{
			this.Bits.FixedElementField = (this.Bits.FixedElementField | other.Bits.FixedElementField);
			*(ref this.Bits.FixedElementField + 8) |= *(ref other.Bits.FixedElementField + 8);
			*(ref this.Bits.FixedElementField + (IntPtr)2 * 8) |= *(ref other.Bits.FixedElementField + (IntPtr)2 * 8);
		...
		public unsafe void Xor(BitSet192 other)
		{
			this.Bits.FixedElementField = (this.Bits.FixedElementField ^ other.Bits.FixedElementField);
			*(ref this.Bits.FixedElementField + 8) ^= *(ref other.Bits.FixedElementField + 8);
			*(ref this.Bits.FixedElementField + (IntPtr)2 * 8) ^= *(ref other.Bits.FixedElementField + (IntPtr)2 * 8);
		...
		public unsafe void AndNot(BitSet192 other)
		{
			this.Bits.FixedElementField = (this.Bits.FixedElementField & ~other.Bits.FixedElementField);
			*(ref this.Bits.FixedElementField + 8) &= ~(*(ref other.Bits.FixedElementField + 8));
			*(ref this.Bits.FixedElementField + (IntPtr)2 * 8) &= ~(*(ref other.Bits.FixedElementField + (IntPtr)2 * 8));
		...
		{
			return Maths.CountSetBits(this.Bits.FixedElementField) + Maths.CountSetBits(*(ref this.Bits.FixedElementField + 8)) + Maths.CountSetBits(*(ref this.Bits.FixedElementField + (IntPtr)2 * 8));
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public unsafe bool Any()
		{
			return this.Bits.FixedElementField != 0UL || *(ref this.Bits.FixedElementField + 8) != 0UL || *(ref this.Bits.FixedElementField + (IntPtr)2 * 8) > 0UL;
		}
		...
		public unsafe override int GetHashCode()
		{
			...
			{
				ulong* ptr2 = ptr;
				return HashCodeUtilities.GetArrayHashCode<ulong>(ptr2, 3, 43);
			}
		}
		...
		{
			return this.Bits.FixedElementField == other.Bits.FixedElementField && *(ref this.Bits.FixedElementField + 8) == *(ref other.Bits.FixedElementField + 8) && *(ref this.Bits.FixedElementField + (IntPtr)2 * 8) == *(ref other.Bits.FixedElementField + (IntPtr)2 * 8);
		}

		public unsafe BitSet192.Enumerator GetEnumerator()
		{
			fixed (ulong* ptr = &this.Bits.FixedElementField)
			{
				ulong* bits = ptr;
				return new BitSet192.Enumerator(bits);
			}
		}
		...
		public static bool operator ==(BitSet192 a, BitSet192 b)
		{
			return a.Equals(b);
		}
		...
		[FieldOffset(0)]
		public BitSet192.<Bits>e__FixedBuffer Bits;
