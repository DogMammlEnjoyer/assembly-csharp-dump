...
namespace Fusion
{
	internal struct NetworkObjectConnectionDataList
	{
		...
		public NetworkObjectConnectionData RemoveHead()
		{
			...
			NetworkObjectConnectionData head = this.Head;
			this.Remove(head);
			return head;
		}
		...
		private bool IsInList(NetworkObjectConnectionData item)
		{
			...
			{
				for (NetworkObjectConnectionData networkObjectConnectionData = this.Head; networkObjectConnectionData != null; networkObjectConnectionData = networkObjectConnectionData.Next)
				{
					bool flag2 = networkObjectConnectionData == item;
					if (flag2)
					{
						return true;
					}
