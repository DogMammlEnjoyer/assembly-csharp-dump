...
namespace Liv.Lck.Streaming
{
	public class LckMissingTrackingIdState : LckStreamingBaseState
	{
		...
		{
			LckMissingTrackingIdState.<SwitchStateAfterDelay>d__1 <SwitchStateAfterDelay>d__;
			...
			<SwitchStateAfterDelay>d__.<>t__builder.Start<LckMissingTrackingIdState.<SwitchStateAfterDelay>d__1>(ref <SwitchStateAfterDelay>d__);
