...
namespace DigitalOpus.MB.Core
{
	public static class MB_TextureCombinerSRPCustom_URP
	{
		...
		internal static void ConfigureMaterialKeywords(MB3_TextureCombinerPipeline.TexturePipelineData data, Material resultMat)
		{
			...
			{
				if (MB_TextureCombinerSRPCustom_URP._IsCreatingAtlasForProperty(data, "_BumpMap"))
				{
			...
			{
				MB_TextureCombinerSRPCustom_URP._IsCreatingAtlasForProperty(data, "_SpecGlossMap");
				if (MB_TextureCombinerSRPCustom_URP._IsCreatingAtlasForProperty(data, "_SpecGlossMap"))
				{
			...
			{
				if (MB_TextureCombinerSRPCustom_URP._IsCreatingAtlasForProperty(data, "_MetallicGlossMap"))
				{
			...
			{
				if (MB_TextureCombinerSRPCustom_URP._IsCreatingAtlasForProperty(data, "_ParallaxMap"))
				{
			...
			{
				if (MB_TextureCombinerSRPCustom_URP._IsCreatingAtlasForProperty(data, "_OcclusionMap"))
				{
