...
namespace Meta.Net.NativeWebSocket
{
	public class WebSocket : IWebSocket
	{
		...
		public Task Connect()
		{
			WebSocket.<Connect>d__30 <Connect>d__;
			<Connect>d__.<>t__builder = AsyncTaskMethodBuilder.Create();
			<Connect>d__.<>4__this = this;
			<Connect>d__.<>1__state = -1;
			<Connect>d__.<>t__builder.Start<WebSocket.<Connect>d__30>(ref <Connect>d__);
