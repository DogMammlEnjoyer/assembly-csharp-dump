...
namespace Oculus.Interaction
{
	public class FirstHoverInteractorGroup : InteractorGroup
	{
		public override bool ShouldHover
		{
			get
			{
				return base.State == InteractorState.Normal && base.AnyInteractor(FirstHoverInteractorGroup.IsNormalAndShouldHoverPredicate);
			}
		}
		...
		{
			int interactorIndex;
			if (base.TryGetBestCandidateIndex(FirstHoverInteractorGroup.IsNormalAndShouldHoverPredicate, out interactorIndex, -1, skipIndex))
			{
				this.HoverAtIndex(interactorIndex);
				return true;
			}
			return false;
		}
		...
		public override void Unhover()
		{
			...
			if (this._bestInteractor != null)
			{
				...
				this.TryHover(this._bestInteractorIndex);
			}
			if (this._bestInteractor == null)
			{
