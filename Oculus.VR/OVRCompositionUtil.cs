...
internal class OVRCompositionUtil
{
	...
	{
		return OVRCompositionUtil.GetWorldPosition(Camera.main, trackingSpacePosition);
	}
	...
	public static float GetMaximumBoundaryDistance(Camera camera, OVRBoundary.BoundaryType boundaryType)
	{
		...
		{
			Vector3 worldPosition = OVRCompositionUtil.GetWorldPosition(camera, trackingSpacePosition);
