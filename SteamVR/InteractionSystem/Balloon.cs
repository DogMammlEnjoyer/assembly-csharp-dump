...
namespace Valve.VR.InteractionSystem
{
	public class Balloon : MonoBehaviour
	{
		...
		{
			if (this.balloonRigidbody.linearVelocity.sqrMagnitude > this.maxVelocity)
			{
				this.balloonRigidbody.linearVelocity *= 0.97f;
			}
		}
		...
		private void OnCollisionEnter(Collision collision)
		{
			...
			if (this.balloonRigidbody.linearVelocity.magnitude > this.maxVelocity * 10f)
			{
				this.balloonRigidbody.linearVelocity = this.balloonRigidbody.linearVelocity.normalized * this.maxVelocity;
			}
			if (this.hand != null)
			{
