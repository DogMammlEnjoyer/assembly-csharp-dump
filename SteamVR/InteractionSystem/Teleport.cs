	...
	public class Teleport : MonoBehaviour
	{
		...
		private void PlayPointerHaptic(bool validLocation)
		{
			if (this.pointerHand != null)
			{
				if (validLocation)
				{
					this.pointerHand.TriggerHapticPulse(800);
					return;
				}
				this.pointerHand.TriggerHapticPulse(100);
			}
		}
		...
		private void TeleportPlayer()
		{
			...
			if (this.teleportingToMarker.ShouldMovePlayer())
			{
				...
				if (this.player.leftHand.currentAttachedObjectInfo != null)
				{
					this.player.leftHand.ResetAttachedTransform(this.player.leftHand.currentAttachedObjectInfo.Value);
				}
				if (this.player.rightHand.currentAttachedObjectInfo != null)
				{
		...
		public void CancelTeleportHint()
		{
			...
			{
				ControllerButtonHints.HideTextHint(this.player.leftHand, this.teleportAction);
				ControllerButtonHints.HideTextHint(this.player.rightHand, this.teleportAction);
		...
		private IEnumerator TeleportHintCoroutine()
		{
			...
			for (;;)
			{
				...
				foreach (Hand hand in this.player.hands)
				{
					...
					bool flag2 = !string.IsNullOrEmpty(ControllerButtonHints.GetActiveHintText(hand, this.teleportAction));
					if (flag)
					{
						if (!flag2)
						{
							ControllerButtonHints.ShowTextHint(hand, this.teleportAction, "Teleport", true);
					...
					{
						ControllerButtonHints.HideTextHint(hand, this.teleportAction);
					}
				}
		...
		private bool WasTeleportButtonReleased(Hand hand)
		{
			...
			return this.teleportAction.GetStateUp(hand.handType);
		}
		...
		private bool IsTeleportButtonDown(Hand hand)
		{
			...
			return this.teleportAction.GetState(hand.handType);
		}
		...
		private bool WasTeleportButtonPressed(Hand hand)
		{
			...
			return this.teleportAction.GetStateDown(hand.handType);
		}
