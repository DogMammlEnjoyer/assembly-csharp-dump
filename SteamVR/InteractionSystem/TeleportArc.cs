...
namespace Valve.VR.InteractionSystem
{
	public class TeleportArc : MonoBehaviour
	{
		...
		private void CreateLineRendererObjects()
		{
			...
			{
				GameObject gameObject2 = new GameObject("LineRenderer_" + i.ToString());
				...
				this.lineRenderers[i].startWidth = this.thickness * this.scale;
				this.lineRenderers[i].endWidth = this.thickness * this.scale;
		...
		public Vector3 GetArcPositionAtTime(float time)
		{
			...
			return this.startPos + (this.projectileVelocity * time + 0.5f * time * time * a) * this.scale;
		}
