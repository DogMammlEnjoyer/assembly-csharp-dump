...
namespace Valve.VR.InteractionSystem
{
	public class TeleportPoint : TeleportMarkerBase
	{
		...
		private void Awake()
		{
			...
			this.tintColorID = Shader.PropertyToID("_BaseColor");
		...
		public void TeleportToScene()
		{
			...
			{
				Debug.Log("<b>[SteamVR Interaction]</b> TeleportPoint: Hook up your level loading logic to switch to new scene: " + this.switchToScene, this);
				return;
			}
			Debug.LogError("<b>[SteamVR Interaction]</b> TeleportPoint: Invalid scene name to switch to: " + this.switchToScene, this);
		}
