	...
	public class SteamVR_Input_BindingFile_Source_Input_StringDictionary : Dictionary<string, string>
	{
		public override bool Equals(object obj)
		{
			if (obj is SteamVR_Input_BindingFile_Source_Input_StringDictionary)
			{
				...
				return this == steamVR_Input_BindingFile_Source_Input_StringDictionary || (base.Count == steamVR_Input_BindingFile_Source_Input_StringDictionary.Count && !this.Except(steamVR_Input_BindingFile_Source_Input_StringDictionary).Any<KeyValuePair<string, string>>());
			}
