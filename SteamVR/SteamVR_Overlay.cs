	...
	public class SteamVR_Overlay : MonoBehaviour
	{
		...
		public void UpdateOverlay()
		{
			...
			if (steamVR_Camera != null && steamVR_Camera.origin != null)
			{
				...
				overlay.SetOverlayTransformAbsolute(this.handle, SteamVR.settings.trackingSpace, ref hmdMatrix34_t);
			}
		...
		public bool ComputeIntersection(Vector3 source, Vector3 direction, ref SteamVR_Overlay.IntersectionResults results)
		{
			...
			vroverlayIntersectionParams_t.eOrigin = SteamVR.settings.trackingSpace;
