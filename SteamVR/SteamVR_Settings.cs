...
namespace Valve.VR
{
	public class SteamVR_Settings : ScriptableObject
	{
		...
		public ETrackingUniverseOrigin trackingSpace
		{
			get
			{
				return this.trackingSpaceOrigin;
			}
			set
			{
		...
		{
			return (this.inputUpdateMode & tocheck) == tocheck;
		}

		public bool IsPoseUpdateMode(SteamVR_UpdateModes tocheck)
		{
			return (this.poseUpdateMode & tocheck) == tocheck;
		}
		...
		{
			if (SteamVR_Settings._instance == null)
			{
				SteamVR_Settings._instance = Resources.Load<SteamVR_Settings>("SteamVR_Settings");
				if (SteamVR_Settings._instance == null)
				{
					SteamVR_Settings._instance = ScriptableObject.CreateInstance<SteamVR_Settings>();
				}
				SteamVR_Settings.SetDefaultsIfNeeded();
			}
		}
		...
		private static void SetDefaultsIfNeeded()
		{
			if (string.IsNullOrEmpty(SteamVR_Settings._instance.editorAppKey))
			{
				...
				Debug.Log("<b>[SteamVR Setup]</b> Generated you an editor app key of: " + SteamVR_Settings._instance.editorAppKey + ". This lets the editor tell SteamVR what project this is. Has no effect on builds. This can be changed in Assets/SteamVR/Resources/SteamVR_Settings");
			}
		...
		public SteamVR_Action_Pose mixedRealityCameraPose = SteamVR_Input.GetPoseAction("ExternalCamera", false);
