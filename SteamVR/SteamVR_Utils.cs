...
public static class SteamVR_Utils
{
	...
	public static Quaternion GetRotation(this Matrix4x4 matrix)
	{
		...
		quaternion.x = Mathf.Sign(quaternion.x) * Mathf.Abs(matrix.m21 - matrix.m12);
		quaternion.y = Mathf.Sign(quaternion.y) * Mathf.Abs(matrix.m02 - matrix.m20);
		quaternion.z = Mathf.Sign(quaternion.z) * Mathf.Abs(matrix.m10 - matrix.m01);
		return quaternion;
	}
