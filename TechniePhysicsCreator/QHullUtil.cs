	...
	public class QHullUtil
	{
		public static Mesh FindConvexHull(string debugName, Mesh inputMesh, bool showErrorInLog)
		{
			...
			for (int i = 0; i < triangles.Length; i += 3)
			{
				...
				array[i] = new Point3d((double)vector.x, (double)vector.y, (double)vector.z);
				array[i + 1] = new Point3d((double)vector2.x, (double)vector2.y, (double)vector2.z);
				array[i + 2] = new Point3d((double)vector3.x, (double)vector3.y, (double)vector3.z);
			}
