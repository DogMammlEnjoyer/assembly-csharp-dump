...
namespace Technie.PhysicsCreator
{
	...
	public class VhacdParameters
	{
		...
		{
			this.resolution = 100000U;
			this.concavity = 0.001f;
			this.planeDownsampling = 4U;
			this.convexhullDownsampling = 4U;
			this.alpha = 0.05f;
			this.beta = 0.05f;
			this.pca = 0U;
			this.mode = 0U;
			this.maxNumVerticesPerCH = 64U;
			this.minVolumePerCH = 0.0001f;
			this.convexhullApproximation = 1U;
			this.oclAcceleration = 0U;
			this.maxConvexHulls = 1024U;
			this.projectHullVertices = true;
		}
