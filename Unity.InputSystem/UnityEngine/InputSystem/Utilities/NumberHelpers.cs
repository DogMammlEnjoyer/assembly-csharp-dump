...
namespace UnityEngine.InputSystem.Utilities
{
	internal static class NumberHelpers
	{
		...
		{
			uint maxValue = (uint)((1L << (int)inBitSize) - 1L);
			uint uintMaxValue = (uint)((1L << (int)outBitSize) - 1L);
			return NumberHelpers.NormalizedFloatToUInt(NumberHelpers.UIntToNormalizedFloat(value, 0U, maxValue), 0U, uintMaxValue);
		}
	}
}
