...
namespace Unity.Mathematics
{
	...
	public static class noise
	{
		...
		public static float cnoise(float4 P)
		{
			...
			float4 start = math.lerp(math.float4(x3, y, z, w), math.float4(x5, y3, z3, w3), float41.w);
			float4 end = math.lerp(math.float4(x4, y2, z2, w2), math.float4(x6, y4, z4, w4), float41.w);
			float4 float42 = math.lerp(start, end, float41.z);
