...
namespace UnityEngine.Rendering
{
	internal static class LODRenderingUtils
	{
		...
		public static float CalculateScreenRelativeMetricNoBias(LODParameters lodParams)
		{
			...
			float num = LODRenderingUtils.CalculateFOVHalfAngle(lodParams.fieldOfView);
			return 2f * num;
		}
		...
		{
			return Mathf.Sqrt(LODRenderingUtils.CalculateSqrPerspectiveDistance(objPosition, camPosition, sqrScreenRelativeMetric));
		}
