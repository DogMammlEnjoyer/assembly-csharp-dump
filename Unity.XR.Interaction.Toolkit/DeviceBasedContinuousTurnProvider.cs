...
namespace UnityEngine.XR.Interaction.Toolkit
{
	...
	{
		public DeviceBasedContinuousTurnProvider.InputAxes inputBinding
		{
			get
			{
		...
		protected override Vector2 ReadInput()
		{
			...
			InputFeatureUsage<Vector2> usage = DeviceBasedContinuousTurnProvider.k_Vec2UsageList[(int)this.m_InputBinding];
		...
		private DeviceBasedContinuousTurnProvider.InputAxes m_InputBinding;
