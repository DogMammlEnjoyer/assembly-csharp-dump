	...
	public sealed class LookAtConstraint : Behaviour, IConstraint, IConstraintInternal
	{
		...
		public Vector3 rotationAtRest
		{
			get
			{
				...
				Vector3 result;
				LookAtConstraint.get_rotationAtRest_Injected(intPtr, out result);
				return result;
			}
			set
			{
		...
		public Vector3 rotationOffset
		{
			get
			{
				...
				Vector3 result;
				LookAtConstraint.get_rotationOffset_Injected(intPtr, out result);
				return result;
			}
			set
			{
		...
		private ConstraintSource GetSourceInternal(int index)
		{
			...
			LookAtConstraint.GetSourceInternal_Injected(intPtr, index, out result);
			return result;
		}
