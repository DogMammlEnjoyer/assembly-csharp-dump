...
namespace Unity.Jobs.LowLevel.Unsafe
{
	...
	public static class JobsUtility
	{
		...
		public static extern int ThreadIndex { [FreeFunction("GetJobWorkerIndex", IsThreadSafe = true)] [BurstAuthorizedExternalMethod] [MethodImpl(MethodImplOptions.InternalCall)] get; }
