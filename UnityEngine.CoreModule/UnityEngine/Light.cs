	...
	public sealed class Light : Behaviour
	{
		...
		public Color color
		{
			get
			{
				...
				Color result;
				Light.get_color_Injected(intPtr, out result);
				return result;
			}
			set
			{
		...
		public Vector4 boundingSphereOverride
		{
			get
			{
				...
				Vector4 result;
				Light.get_boundingSphereOverride_Injected(intPtr, out result);
				return result;
			}
			set
			{
		...
		public Matrix4x4 shadowMatrixOverride
		{
			get
			{
				...
				Matrix4x4 result;
				Light.get_shadowMatrixOverride_Injected(intPtr, out result);
				return result;
			}
			set
			{
		...
		public LightBakingOutput bakingOutput
		{
			get
			{
				...
				Light.get_bakingOutput_Injected(intPtr, out result);
				return result;
			}
			set
			{
		...
		public Vector2 areaSize
		{
			get
			{
				...
				Vector2 result;
				Light.get_areaSize_Injected(intPtr, out result);
				return result;
			}
			set
			{
