...
namespace UnityEngine
{
	public static class StackTraceUtility
	{
		...
		public unsafe static string ExtractStackTrace()
		{
			...
			{
				StackTrace stackFrames = new StackTrace(1, true);
				string text = StackTraceUtility.ExtractFormattedStackTrace(stackFrames);
				result = text;
			}
			return result;
		}
		...
		internal static void ExtractStringFromExceptionInternal(object exceptiono, out string message, out string stackTrace)
		{
			...
			StackTrace stackFrames = new StackTrace(1, true);
			stringBuilder.Append(StackTraceUtility.ExtractFormattedStackTrace(stackFrames));
