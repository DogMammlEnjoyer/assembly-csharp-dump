...
namespace UnityEngineInternal.Input
{
	...
	internal class NativeInputSystem
	{
		...
		internal static extern bool allowInputDeviceCreationFromEvents { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

		[NativeProperty("NormalizeScrollWheelDelta")]
		internal static extern bool normalizeScrollWheelDelta { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
