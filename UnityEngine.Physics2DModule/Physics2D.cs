...
namespace UnityEngine
{
	...
	public class Physics2D
	{
		...
		public static LayerMask simulationLayers
		{
			...
			{
				LayerMask result;
				Physics2D.get_simulationLayers_Injected(out result);
				return result;
			}
			set
			{
		...
		[StaticAccessor("GetPhysics2DSettings()")]
		public static extern bool useSubStepping { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

		[StaticAccessor("GetPhysics2DSettings()")]
		public static extern bool useSubStepContacts { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

		[StaticAccessor("GetPhysics2DSettings()")]
		public static extern float minSubStepFPS { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }

		[StaticAccessor("GetPhysics2DSettings()")]
		public static extern int maxSubStepCount { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
		...
		[StaticAccessor("GetPhysics2DSettings()")]
		public static extern float contactThreshold { [MethodImpl(MethodImplOptions.InternalCall)] get; [MethodImpl(MethodImplOptions.InternalCall)] set; }
		...
		private static ColliderDistance2D Distance_Internal([NotNull] Collider2D colliderA, [NotNull] Collider2D colliderB)
		{
			...
			Physics2D.Distance_Internal_Injected(intPtr, intPtr2, out result);
			return result;
		}
		...
		private static ColliderDistance2D DistanceFrom_Internal([NotNull] Collider2D colliderA, Vector2 positionA, float angleA, [NotNull] Collider2D colliderB, Vector2 positionB, float angleB)
		{
			...
			ColliderDistance2D result;
			Physics2D.DistanceFrom_Internal_Injected(intPtr, ref positionA, angleA, intPtr2, ref positionB, angleB, out result);
			return result;
		}
		...
		private static Vector2 ClosestPoint_Collider(Vector2 position, [NotNull] Collider2D collider)
		{
			...
			Vector2 result;
			Physics2D.ClosestPoint_Collider_Injected(ref position, intPtr, out result);
			return result;
		}
		...
		private static Vector2 ClosestPoint_Rigidbody(Vector2 position, [NotNull] Rigidbody2D rigidbody)
		{
			...
			Vector2 result;
			Physics2D.ClosestPoint_Rigidbody_Injected(ref position, intPtr, out result);
			return result;
		}
