...
namespace UnityEngine.UIElements.Experimental
{
	internal class EventDebuggerCallTrace : EventDebuggerTrace
	{
		...
		public EventDebuggerCallTrace(IPanel panel, EventBase evt, int cbHashCode, string cbName, bool propagationHasStopped, bool immediatePropagationHasStopped, long duration, IEventHandler mouseCapture) : base(panel, evt, duration, mouseCapture)
		{
