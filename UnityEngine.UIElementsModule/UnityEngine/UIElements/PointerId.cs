...
namespace UnityEngine.UIElements
{
	public static class PointerId
	{
		...
		public static readonly int trackedPointerIdBase = PointerId.penPointerIdBase + PointerId.penPointerCount;

		public static readonly int trackedPointerCount = 8;

		internal static readonly int[] screenHoveringPointers = new int[]
		{
