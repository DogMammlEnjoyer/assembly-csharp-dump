...
namespace UnityEngine
{
	...
	public sealed class RectTransformUtility
	{
		...
		{
			Vector2 result;
			RectTransformUtility.PixelAdjustPoint_Injected(ref point, Object.MarshalledUnityObject.Marshal<Transform>(elementTransform), Object.MarshalledUnityObject.Marshal<Canvas>(canvas), out result);
			return result;
		}
		...
		{
			Rect result;
			RectTransformUtility.PixelAdjustRect_Injected(Object.MarshalledUnityObject.Marshal<RectTransform>(rectTransform), Object.MarshalledUnityObject.Marshal<Canvas>(canvas), out result);
			return result;
		}
