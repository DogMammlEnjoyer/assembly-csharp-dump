...
{
	public class InterfaceCollectionFormatter<[Nullable(2)] T> : IYamlFormatter<ICollection<T>>, IYamlFormatter
	{
		[NullableContext(1)]
		public void Serialize(ref Utf8YamlEmitter emitter, [Nullable(new byte[]
		{
			2,
			1
		})] ICollection<T> value, YamlSerializationContext context)
		{
			if (value == null)
			{
				emitter.WriteNull();
