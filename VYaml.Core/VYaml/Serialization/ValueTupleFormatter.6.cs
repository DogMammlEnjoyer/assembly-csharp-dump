...
namespace VYaml.Serialization
{
	[NullableContext(2)]
	[Nullable(0)]
	public class ValueTupleFormatter<T1, T2, T3, T4, T5, T6> : IYamlFormatter<ValueTuple<T1, T2, T3, T4, T5, T6>>, IYamlFormatter
	{
		[NullableContext(1)]
		public void Serialize(ref Utf8YamlEmitter emitter, [Nullable(new byte[]
		{
			...
			1,
			1
		})] ValueTuple<T1, T2, T3, T4, T5, T6> value, YamlSerializationContext context)
		{
		...
		public ValueTuple<T1, T2, T3, T4, T5, T6> Deserialize(ref YamlParser parser, YamlDeserializationContext context)
		{
			...
			return new ValueTuple<T1, T2, T3, T4, T5, T6>(item, item2, item3, item4, item5, item6);
		}
	}
}
