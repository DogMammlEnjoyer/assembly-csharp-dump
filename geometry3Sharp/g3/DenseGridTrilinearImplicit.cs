...
namespace g3
{
	public class DenseGridTrilinearImplicit : BoundedImplicitFunction3d, ImplicitFunction3d
	{
		...
		{
			this.Grid = sdf_grid.Grid;
			this.GridOrigin = sdf_grid.GridOrigin;
			this.CellSize = (double)sdf_grid.CellSize;
		}
		...
		public double Value(ref Vector3d pt)
		{
			...
			double num10;
			double num11;
			this.Grid.get_x_pair(num, num2, num4, out num10, out num11);
			double num12 = (1.0 - num7) * (1.0 - num8);
			double num13 = (num9 * num10 + num6 * num11) * num12;
			this.Grid.get_x_pair(num, num2, num5, out num10, out num11);
			num12 = (1.0 - num7) * num8;
			double num14 = num13 + (num9 * num10 + num6 * num11) * num12;
			this.Grid.get_x_pair(num, num3, num4, out num10, out num11);
			num12 = num7 * (1.0 - num8);
			double num15 = num14 + (num9 * num10 + num6 * num11) * num12;
			this.Grid.get_x_pair(num, num3, num5, out num10, out num11);
			num12 = num7 * num8;
		...
		public Vector3d Gradient(ref Vector3d pt)
		{
			...
			double num7;
			double num8;
			this.Grid.get_x_pair(num, num2, num3, out num7, out num8);
			double num9;
			double num10;
			this.Grid.get_x_pair(num, j, num3, out num9, out num10);
			double num11;
			double num12;
			this.Grid.get_x_pair(num, num2, k, out num11, out num12);
			double num13;
			double num14;
			this.Grid.get_x_pair(num, j, k, out num13, out num14);
